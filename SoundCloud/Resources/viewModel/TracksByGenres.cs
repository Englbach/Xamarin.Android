...
namespace SoundCloud
{
	...
	public class TracksByGenres : Fragment
	{
		...
		/*
		public List<TrackModel.Track> mListData=new List<TrackModel.Track>();
		public void AddArrayData(List<TrackModel.Track> mdata, int position)
		{
			mListData = mdata;
			mPosition = position;
		}
		*/
		...
		{
			return inflater.Inflate (Resource.Layout.TracksByGenreFragment, container, false);
